#!/usr/bin/env python3
"""
🧪 TEST BUY AND SELL - Migrated Token
Token: CnN6E68w6QytynScJbHUzBFDpPged8dneVji8oqMpump
Buy 0.001 SOL, wait 5 seconds, sell
"""
...
def test_buy():
    ...
    if result.get('status') == 'executed':
        print(f"✅ SUCCESS!")
        print(f"Tx: {result.get('transaction_signature', 'N/A')[:50]}...")
...
def main():
    print("\n" + "="*60)
    print("🚀 MIGRATED TOKEN TEST")
    print("="*60)
    print(f"Token: CnN6E68w6QytynScJbHUzBFDpPged8dneVji8oqMpump")
    print(f"Wallet: {WALLET}")
    print(f"Testing: Buy 0.001 SOL → Wait 5s → Sell")
