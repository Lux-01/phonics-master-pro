#!/usr/bin/env python3
"""
🧪 TEST BUY AND SELL - 6TyK5BiBRJPdU4o1naDaNb54kR9nF4wk7nwu6iUFpump
Buy 0.001 SOL, wait 5 seconds, then sell
"""
...
def main():
    ...
    print("\n" + "="*60)
    print("🚀 BUY AND SELL TEST - Ultra API")
    print("="*60)
    print(f"Token: 6TyK5BiBRJPdU4o1naDaNb54kR9nF4wk7nwu6iUFpump")
    print(f"Using Jupiter Ultra API")
    print(f"API: https://lite-api.jup.ag/ultra/v1")
    ...
    if tokens_received:
        ...
        if sell_success:
            ...
            print("="*60)
            print("✅ Buy executed successfully (Ultra API)")
            print("✅ Sell executed successfully (Ultra API)")
